package edu.esprit.kaddem.converters;
...
public class MergePatchHttpMessageConverter extends AbstractHttpMessageConverter<JsonMergePatch> {
    public MergePatchHttpMessageConverter() {
